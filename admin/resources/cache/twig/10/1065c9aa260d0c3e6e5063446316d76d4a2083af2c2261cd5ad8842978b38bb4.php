...
/* default/AudioClub/audio_years/audio_years.js.twig */
class __TwigTemplate_5892a58302a22c27fc6cf5bfde4e5d09714d015e5ef8978f7fd658f3d7b5c583 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "/edit-audio-years' data-yearsid='\" + id + \"' id='edit_audio_years_\" + id + \"'>\\n\\
                                                                    <span>";
        // line 30
        ...
        echo "</span>\\n\\
                                                            ...
                                                            <li>\\n\\
                                                                <a class='remove-audio-years no_context_menu' \" + (albums_count != \"0\" ? \"disabled='disabled' warning_msg='";
        // line 34
        echo twig_escape_filter($this->env, $this->env->getExtension('Lib\EmptyTranslationExtension')->trans("First, delete or modify all the albums of this year"), "html", null, true);
        echo "'\" : \"\") + \"  data-yearsid='\" + id + \"'>\\n\\
                                                                    <span>";
        // line 35
        ...
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "controller_alias", []), "html", null, true);
        echo "/edit-audio-years\" data-yearsid=\"' + id + '\" id=\"edit_audio_years_' + id + '\">' + name + '</a>';
                    }
                }
            }).dataTable({
                \"processing\": true,
        ...
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "controller_alias", []), "html", null, true);
        echo "/check-audio-years-name', sendData);
                    }
                    return false;
                });*/
...
\t\t\t\t\t}
        ...
        */
        ...
        function openModalBox(obj){
            \$('#modalbox').find('.modal-header-name span').removeClass(\"txt-danger\").text( obj.data('yearsid') ? '";
        // line 204
        echo twig_escape_filter($this->env, $this->env->getExtension('Lib\EmptyTranslationExtension')->trans("Edit year"), "html", null, true);
        echo "' : '";
...
";
    ...
    {
        return "default/AudioClub/audio_years/audio_years.js.twig";
    }
    ...
    {
        return new Source("", "default/AudioClub/audio_years/audio_years.js.twig", "/var/www/html/stalker_portal/admin/resources/views/default/AudioClub/audio_years/audio_years.js.twig");
    }
}
