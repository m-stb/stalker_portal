...
/* default/AudioClub/audio_genres/audio_genres.js.twig */
class __TwigTemplate_5331238a721c45eb6e444a1c3660c53651091f4d976e83193fdebaa26914ade5 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo "/edit-audio-genres' data-genresid='\" + id + \"' id='edit_audio_genres_\" + id + \"'>\\n\\
                                                                    <span>";
        // line 30
        ...
        echo "</span>\\n\\
                                                            ...
                                                            <li>\\n\\
                                                                <a class='remove-audio-genres no_context_menu' \" + (albums_count != \"0\" ? \"disabled='disabled' warning_msg='";
        // line 34
        echo twig_escape_filter($this->env, $this->env->getExtension('Lib\EmptyTranslationExtension')->trans("First, delete or modify all the albums of this genre"), "html", null, true);
        echo "'\" : \"\") + \" data-genresid='\" + id + \"'>\\n\\
                                                                    <span>";
        // line 35
        ...
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "controller_alias", []), "html", null, true);
        echo "/edit-audio-genres\" data-genresid=\"'+id+'\" id=\"edit_audio_genres_' + id + '\">' + name + '</a>';
                    }
                }
            }).dataTable({
                \"processing\": true,
        ...
        echo "/";
        echo twig_escape_filter($this->env, $this->getAttribute(($context["app"] ?? $this->getContext($context, "app")), "controller_alias", []), "html", null, true);
        echo "/check-audio-genres-name', sendData);
                    }
                    return false;
                });*/
        ...
        function openModalBox(obj){
            \$('#modalbox').find('.modal-header-name span').removeClass(\"txt-danger\").text( obj.data('genresid') ? '";
        // line 193
        ...
        echo "<span class=\"icon-required\">*</span></label>\\n\\
                                <div class=\"col-xs-10 col-sm-8\">\\n\\
                                    <span class=\"col-xs-8 col-sm-8\">\\n\\
                                        <input id=\"genre_id\" type=\"hidden\" name=\"id\">\\n\\
                                        <input id=\"audio_genres_name\" class=\"form-control own_fields\" type=\"text\" name=\"name\" \\n\\
        ...
        echo "</button>\\n\\
            ...
            if (obj.data('genresid')) {
                \$('#modalbox').find('.devoops-modal-inner').find('input[name=\"id\"]').val(obj.data('genresid'));
            ...
            if (obj.data('genresid')) {
                ...
                \$(\"#audio_genres_name\").removeAttr('data-validation-event');
                \$.validate(conf);
...
function setServerValidationRequestParams() {
    ...
    \$('#audio_genres_name').attr('data-validation-req-params', JSON.stringify(param) );
}
...
function setDefaultValidationConfig(conf) {
    ...
    \$(document).off('change', '#audio_genres_name');
}
...
function setEditValidationConfig(conf) {
    ...
    \$(document).one('change', '#audio_genres_name', function (e) {
...
";
    ...
    {
        return "default/AudioClub/audio_genres/audio_genres.js.twig";
    }
    ...
    {
        return array (  315 => 217,  311 => 216,  297 => 207,  288 => 201,  275 => 193,  240 => 161,  233 => 157,  180 => 107,  162 => 94,  123 => 57,  117 => 55,  115 => 54,  109 => 51,  101 => 48,  89 => 41,  80 => 35,  76 => 34,  69 => 30,  63 => 29,  33 => 2,  30 => 1,);
    }
    ...
    {
        return new Source("", "default/AudioClub/audio_genres/audio_genres.js.twig", "/var/www/html/stalker_portal/admin/resources/views/default/AudioClub/audio_genres/audio_genres.js.twig");
    }
}
